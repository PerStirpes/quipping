...
from utils import get_request_token, get_oauth_verifier_url, get_access_token
...
Database.initialize(host='localhost', database='twitter_db', user='postgres', password='')
