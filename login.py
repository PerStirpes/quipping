...
from utils import get_request_token, get_oauth_verifier, get_access_token


Database.initialize(user='postgres', password='', host='localhost', database='twitter_db')
...
tweets = user.twitter_request('https://api.twitter.com/1.1/search/tweets.json?q=')
